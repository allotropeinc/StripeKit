...
public struct PaymentMethodDetailsCardPresent: Codable {
    ...
    public var isIncrementalAuthorizationSupported: Bool?
    ...
    public init(amountAuthorized: Int? = nil, brand: String? = nil, captureBefore: Int? = nil, cardholderName: String? = nil, country: String? = nil, emvAuthData: String? = nil, expMonth: Int, expYear: Int, fingerprint: String? = nil, funding: String? = nil, generatedCard: String? = nil, isIncrementalAuthorizationSupported: Bool? = nil, last4: String? = nil, network: String? = nil, isOvercaptureSupported: Bool? = nil, readMethod: ReadMethod? = nil, receipt: PaymentMethodDetailsCardPresentReceipt? = nil) {
        ...
        self.isIncrementalAuthorizationSupported = isIncrementalAuthorizationSupported
        self.last4 = last4
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.amountAuthorized = try values.decodeIfPresent(Int.self, forKey: "amount_authorized")
        self.brand = try values.decodeIfPresent(String.self, forKey: "brand")
        self.captureBefore = try values.decodeIfPresent(Int.self, forKey: "capture_before")
        ...
        self.isIncrementalAuthorizationSupported = try values.decodeIfPresent(Bool.self, forKey: "incremental_authorization_supported")
        ...
        self.isOvercaptureSupported = try values.decodeIfPresent(Bool.self, forKey: "overcapture_supported")
        self.readMethod = try values.decodeIfPresent(ReadMethod.self, forKey: "read_method")
        self.receipt = try values.decodeIfPresent(PaymentMethodDetailsCardPresentReceipt.self, forKey: "receipt")
    }

    public func encode(to encoder: Encoder) throws {
        var values = encoder.container(keyedBy: StringCodingKey.self)
        try values.encodeIfPresent(amountAuthorized, forKey: "amount_authorized")
        try values.encodeIfPresent(brand, forKey: "brand")
        try values.encodeIfPresent(captureBefore, forKey: "capture_before")
        ...
        try values.encodeIfPresent(isIncrementalAuthorizationSupported, forKey: "incremental_authorization_supported")
        try values.encodeIfPresent(last4, forKey: "last4")
        try values.encodeIfPresent(network, forKey: "network")
        try values.encodeIfPresent(isOvercaptureSupported, forKey: "overcapture_supported")
