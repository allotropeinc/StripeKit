...
public struct PaymentIntentPaymentMethodOptionsAcssDebit: Codable {
    ...
    public init(mandateOptions: PaymentIntentPaymentMethodOptionsMandateOptionsAcssDebit? = nil, setupFutureUsage: SetupFutureUsage? = nil, verificationMethod: VerificationMethod? = nil) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.mandateOptions = try values.decodeIfPresent(PaymentIntentPaymentMethodOptionsMandateOptionsAcssDebit.self, forKey: "mandate_options")
