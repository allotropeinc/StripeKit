...
public struct PaymentMethodCardWallet: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.masterpass = try values.decodeIfPresent(PaymentMethodCardWalletMasterpass.self, forKey: "masterpass")
        self.samsungPay = try values.decodeIfPresent([String: AnyJSON].self, forKey: "samsung_pay")
        self.type = try values.decode(`Type`.self, forKey: "type")
        self.visaCheckout = try values.decodeIfPresent(PaymentMethodCardWalletVisaCheckout.self, forKey: "visa_checkout")
    }
