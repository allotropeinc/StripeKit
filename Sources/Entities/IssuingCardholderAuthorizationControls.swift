...
public struct IssuingCardholderAuthorizationControls: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.allowedCategories = try values.decodeIfPresent([AllowedCategory].self, forKey: "allowed_categories")
        self.blockedCategories = try values.decodeIfPresent([BlockedCategory].self, forKey: "blocked_categories")
        self.spendingLimits = try values.decodeIfPresent([IssuingCardholderSpendingLimit].self, forKey: "spending_limits")
        self.spendingLimitsCurrency = try values.decodeIfPresent(String.self, forKey: "spending_limits_currency")
    }

    public func encode(to encoder: Encoder) throws {
        var values = encoder.container(keyedBy: StringCodingKey.self)
        try values.encodeIfPresent(allowedCategories, forKey: "allowed_categories")
        try values.encodeIfPresent(blockedCategories, forKey: "blocked_categories")
        try values.encodeIfPresent(spendingLimits, forKey: "spending_limits")
        try values.encodeIfPresent(spendingLimitsCurrency, forKey: "spending_limits_currency")
    }
}
