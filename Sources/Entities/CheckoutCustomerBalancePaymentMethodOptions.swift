...
public struct CheckoutCustomerBalancePaymentMethodOptions: Codable {
    ...
    public init(bankTransfer: CheckoutCustomerBalanceBankTransferPaymentMethodOptions? = nil, fundingType: FundingType? = nil, setupFutureUsage: SetupFutureUsage? = nil) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.bankTransfer = try values.decodeIfPresent(CheckoutCustomerBalanceBankTransferPaymentMethodOptions.self, forKey: "bank_transfer")
