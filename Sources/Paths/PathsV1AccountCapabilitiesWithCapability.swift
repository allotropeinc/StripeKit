...
extension Paths.Account.Capabilities {
    ...
    public struct WithCapability {
        ...
        public func get(expand: [String]? = nil) -> Request<StripeKit.Capability> {
            Request(method: "GET", url: path, query: makeGetQuery(expand), id: "GetAccountCapabilitiesCapability")
        }
        ...
        public func post(_ body: PostRequest? = nil) -> Request<StripeKit.Capability> {
            Request(method: "POST", url: path, body: body.map(URLQueryEncoder.encode)?.percentEncodedQuery, id: "PostAccountCapabilitiesCapability")
        }
