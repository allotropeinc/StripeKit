...
extension Paths.TestHelpers.Refunds.WithRefund {
    ...
    public struct Expire {
        ...
        public func post(_ body: PostRequest? = nil) -> Request<StripeKit.Refund> {
            Request(method: "POST", url: path, body: body.map(URLQueryEncoder.encode)?.percentEncodedQuery, id: "PostTestHelpersRefundsRefundExpire")
        }
