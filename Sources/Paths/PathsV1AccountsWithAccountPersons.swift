...
extension Paths.Accounts.WithAccount {
    ...
    public struct Persons {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<GetResponse> {
            Request(method: "GET", url: path, query: parameters?.asQuery, id: "GetAccountsAccountPersons")
        }

        /// PersonList
        public struct GetResponse: Decodable {
            public var data: [StripeKit.Person]
            ...
            public init(data: [StripeKit.Person], hasMore: Bool, object: Object, url: String) {
                self.data = data
            ...
            public init(from decoder: Decoder) throws {
                ...
                self.data = try values.decode([StripeKit.Person].self, forKey: "data")
        ...
        public func post(_ body: PostRequest? = nil) -> Request<StripeKit.Person> {
            Request(method: "POST", url: path, body: body.map(URLQueryEncoder.encode)?.percentEncodedQuery, id: "PostAccountsAccountPersons")
        }
