...
extension Paths {
    ...
    public struct Reviews {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<GetResponse> {
            Request(method: "GET", url: path, query: parameters?.asQuery, id: "GetReviews")
        }

        /// RadarReviewList
        public struct GetResponse: Decodable {
            public var data: [StripeKit.Review]
            ...
            public init(data: [StripeKit.Review], hasMore: Bool, object: Object, url: String) {
                self.data = data
            ...
            public init(from decoder: Decoder) throws {
                ...
                self.data = try values.decode([StripeKit.Review].self, forKey: "data")
