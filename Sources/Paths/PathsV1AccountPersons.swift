...
extension Paths.Account {
    ...
    public struct Persons {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<GetResponse> {
            Request(method: "GET", url: path, query: parameters?.asQuery, id: "GetAccountPersons")
        }
        ...
        public func post(_ body: PostRequest? = nil) -> Request<StripeKit.Person> {
            Request(method: "POST", url: path, body: body.map(URLQueryEncoder.encode)?.percentEncodedQuery, id: "PostAccountPersons")
        }
