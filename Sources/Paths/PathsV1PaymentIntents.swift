...
extension Paths {
    ...
    public struct PaymentIntents {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<GetResponse> {
            Request(method: "GET", url: path, query: parameters?.asQuery, id: "GetPaymentIntents")
        }

        /// PaymentFlowsPaymentIntentList
        public struct GetResponse: Decodable {
            public var data: [StripeKit.PaymentIntent]
            ...
            public init(data: [StripeKit.PaymentIntent], hasMore: Bool, object: Object, url: String) {
                self.data = data
            ...
            public init(from decoder: Decoder) throws {
                ...
                self.data = try values.decode([StripeKit.PaymentIntent].self, forKey: "data")
        ...
        public func post(_ body: PostRequest) -> Request<StripeKit.PaymentIntent> {
            Request(method: "POST", url: path, body: URLQueryEncoder.encode(body).percentEncodedQuery, id: "PostPaymentIntents")
        }
        ...
        public struct PostRequest: Encodable {
            ...
            public init(amount: Int, applicationFeeAmount: Int? = nil, automaticPaymentMethods: AutomaticPaymentMethods? = nil, captureMethod: CaptureMethod? = nil, isConfirm: Bool? = nil, confirmationMethod: ConfirmationMethod? = nil, currency: String, customer: String? = nil, description: String? = nil, errorOnRequiresAction: Bool? = nil, expand: [String]? = nil, mandate: String? = nil, mandateData: MandateData? = nil, metadata: [String: String]? = nil, offSession: OffSession? = nil, onBehalfOf: String? = nil, paymentMethod: String? = nil, paymentMethodData: PaymentMethodData? = nil, paymentMethodOptions: PaymentMethodOptions? = nil, paymentMethodTypes: [String]? = nil, radarOptions: RadarOptions? = nil, receiptEmail: String? = nil, returnURL: String? = nil, setupFutureUsage: SetupFutureUsage? = nil, shipping: Shipping? = nil, statementDescriptor: String? = nil, statementDescriptorSuffix: String? = nil, transferData: TransferData? = nil, transferGroup: String? = nil, useStripeSdk: Bool? = nil) {
                self.amount = amount
