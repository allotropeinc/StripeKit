...
extension Paths.Customers.WithCustomer.Subscriptions {
    ...
    public struct WithSubscriptionExposedID {
        ...
        public func get(expand: [String]? = nil) -> Request<StripeKit.Subscription> {
            Request(method: "GET", url: path, query: makeGetQuery(expand), id: "GetCustomersCustomerSubscriptionsSubscriptionExposedId")
        }
        ...
        public func post(_ body: PostRequest? = nil) -> Request<StripeKit.Subscription> {
            Request(method: "POST", url: path, body: body.map(URLQueryEncoder.encode)?.percentEncodedQuery, id: "PostCustomersCustomerSubscriptionsSubscriptionExposedId")
        }
        ...
        public func delete(_ body: DeleteRequest? = nil) -> Request<StripeKit.Subscription> {
            Request(method: "DELETE", url: path, body: body.map(URLQueryEncoder.encode)?.percentEncodedQuery, id: "DeleteCustomersCustomerSubscriptionsSubscriptionExposedId")
        }
