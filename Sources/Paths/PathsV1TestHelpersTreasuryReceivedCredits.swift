...
extension Paths.TestHelpers.Treasury {
    ...
    public struct ReceivedCredits {
        ...
        public func post(_ body: PostRequest) -> Request<StripeKit.TreasuryReceivedCredit> {
            Request(method: "POST", url: path, body: URLQueryEncoder.encode(body).percentEncodedQuery, id: "PostTestHelpersTreasuryReceivedCredits")
        }
