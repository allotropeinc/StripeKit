...
extension Paths {
    ...
    public struct Account {
        ...
        public func get(expand: [String]? = nil) -> Request<StripeKit.Account> {
            Request(method: "GET", url: path, query: makeGetQuery(expand), id: "GetAccount")
        }
        ...
        public func post(_ body: PostRequest? = nil) -> Request<StripeKit.Account> {
            Request(method: "POST", url: path, body: body.map(URLQueryEncoder.encode)?.percentEncodedQuery, id: "PostAccount")
        }
        ...
        public func delete(_ body: DeleteRequest? = nil) -> Request<StripeKit.DeletedAccount> {
            Request(method: "DELETE", url: path, body: body.map(URLQueryEncoder.encode)?.percentEncodedQuery, id: "DeleteAccount")
        }
