...
extension Paths.Issuing.Cardholders {
    ...
    public struct WithCardholder {
        ...
        public func get(expand: [String]? = nil) -> Request<StripeKit.IssuingCardholder> {
            Request(method: "GET", url: path, query: makeGetQuery(expand), id: "GetIssuingCardholdersCardholder")
        }
        ...
        public func post(_ body: PostRequest? = nil) -> Request<StripeKit.IssuingCardholder> {
            Request(method: "POST", url: path, body: body.map(URLQueryEncoder.encode)?.percentEncodedQuery, id: "PostIssuingCardholdersCardholder")
        }
