...
extension Paths.Customers.WithCustomer.BankAccounts {
    ...
    public struct WithID {
        ...
        public func get(expand: [String]? = nil) -> Request<StripeKit.BankAccount> {
            Request(method: "GET", url: path, query: makeGetQuery(expand), id: "GetCustomersCustomerBankAccountsId")
        }
        ...
        public func post(_ body: PostRequest? = nil) -> Request<PostResponse> {
            Request(method: "POST", url: path, body: body.map(URLQueryEncoder.encode)?.percentEncodedQuery, id: "PostCustomersCustomerBankAccountsId")
        }
        ...
        public func delete(_ body: DeleteRequest? = nil) -> Request<DeleteResponse> {
            Request(method: "DELETE", url: path, body: body.map(URLQueryEncoder.encode)?.percentEncodedQuery, id: "DeleteCustomersCustomerBankAccountsId")
        }
