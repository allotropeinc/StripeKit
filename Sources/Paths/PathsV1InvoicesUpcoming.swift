...
extension Paths.Invoices {
    ...
    public struct Upcoming {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<StripeKit.Invoice> {
            Request(method: "GET", url: path, query: parameters?.asQuery, id: "GetInvoicesUpcoming")
        }
