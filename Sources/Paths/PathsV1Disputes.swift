...
extension Paths {
    ...
    public struct Disputes {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<GetResponse> {
            Request(method: "GET", url: path, query: parameters?.asQuery, id: "GetDisputes")
        }

        /// DisputeList
        public struct GetResponse: Decodable {
            public var data: [StripeKit.Dispute]
            ...
            public init(data: [StripeKit.Dispute], hasMore: Bool, object: Object, url: String) {
                self.data = data
            ...
            public init(from decoder: Decoder) throws {
                ...
                self.data = try values.decode([StripeKit.Dispute].self, forKey: "data")
