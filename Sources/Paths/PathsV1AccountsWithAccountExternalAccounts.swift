...
extension Paths.Accounts.WithAccount {
    ...
    public struct ExternalAccounts {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<GetResponse> {
            Request(method: "GET", url: path, query: parameters?.asQuery, id: "GetAccountsAccountExternalAccounts")
        }
        ...
        public func post(_ body: PostRequest? = nil) -> Request<StripeKit.ExternalAccount> {
            Request(method: "POST", url: path, body: body.map(URLQueryEncoder.encode)?.percentEncodedQuery, id: "PostAccountsAccountExternalAccounts")
        }
