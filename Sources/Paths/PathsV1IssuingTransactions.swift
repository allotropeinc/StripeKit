...
extension Paths.Issuing {
    ...
    public struct Transactions {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<GetResponse> {
            Request(method: "GET", url: path, query: parameters?.asQuery, id: "GetIssuingTransactions")
        }

        /// IssuingTransactionList
        public struct GetResponse: Decodable {
            public var data: [StripeKit.IssuingTransaction]
            ...
            public init(data: [StripeKit.IssuingTransaction], hasMore: Bool, object: Object, url: String) {
                self.data = data
            ...
            public init(from decoder: Decoder) throws {
                ...
                self.data = try values.decode([StripeKit.IssuingTransaction].self, forKey: "data")
