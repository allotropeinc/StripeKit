...
extension Paths.PaymentIntents.WithIntent {
    ...
    public struct Confirm {
        ...
        public func post(_ body: PostRequest? = nil) -> Request<StripeKit.PaymentIntent> {
            Request(method: "POST", url: path, body: body.map(URLQueryEncoder.encode)?.percentEncodedQuery, id: "PostPaymentIntentsIntentConfirm")
        }
        ...
        public struct PostRequest: Encodable {
            ...
            public init(captureMethod: CaptureMethod? = nil, clientSecret: String? = nil, errorOnRequiresAction: Bool? = nil, expand: [String]? = nil, mandate: String? = nil, mandateData: MandateData? = nil, offSession: OffSession? = nil, paymentMethod: String? = nil, paymentMethodData: PaymentMethodData? = nil, paymentMethodOptions: PaymentMethodOptions? = nil, paymentMethodTypes: [String]? = nil, radarOptions: RadarOptions? = nil, receiptEmail: ReceiptEmail? = nil, returnURL: String? = nil, setupFutureUsage: SetupFutureUsage? = nil, shipping: Shipping? = nil, useStripeSdk: Bool? = nil) {
                self.captureMethod = captureMethod
