...
extension Paths {
    ...
    public struct Accounts {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<GetResponse> {
            Request(method: "GET", url: path, query: parameters?.asQuery, id: "GetAccounts")
        }

        /// AccountList
        public struct GetResponse: Decodable {
            public var data: [StripeKit.Account]
            ...
            public init(data: [StripeKit.Account], hasMore: Bool, object: Object, url: String) {
                self.data = data
            ...
            public init(from decoder: Decoder) throws {
                ...
                self.data = try values.decode([StripeKit.Account].self, forKey: "data")
        ...
        public func post(_ body: PostRequest? = nil) -> Request<StripeKit.Account> {
            Request(method: "POST", url: path, body: body.map(URLQueryEncoder.encode)?.percentEncodedQuery, id: "PostAccounts")
        }
