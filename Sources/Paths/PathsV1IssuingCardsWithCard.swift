...
extension Paths.Issuing.Cards {
    ...
    public struct WithCard {
        ...
        public func get(expand: [String]? = nil) -> Request<StripeKit.IssuingCard> {
            Request(method: "GET", url: path, query: makeGetQuery(expand), id: "GetIssuingCardsCard")
        }
        ...
        public func post(_ body: PostRequest? = nil) -> Request<StripeKit.IssuingCard> {
            Request(method: "POST", url: path, body: body.map(URLQueryEncoder.encode)?.percentEncodedQuery, id: "PostIssuingCardsCard")
        }
        ...
        public struct PostRequest: Encodable {
            ...
            public struct Pin: Encodable {
                ...
                public var asQuery: [(String, String?)] {
                    let encoder = URLQueryEncoder()
                    encoder.encode(encryptedNumber, forKey: "encrypted_number")
                    return encoder.items
                }
            }
            ...
            public init(cancellationReason: CancellationReason? = nil, expand: [String]? = nil, metadata: Metadata? = nil, pin: Pin? = nil, spendingControls: SpendingControls? = nil, status: Status? = nil) {
