...
extension Paths.Account.People {
    ...
    public struct WithPerson {
        ...
        public func get(expand: [String]? = nil) -> Request<StripeKit.Person> {
            Request(method: "GET", url: path, query: makeGetQuery(expand), id: "GetAccountPeoplePerson")
        }
        ...
        public func post(_ body: PostRequest? = nil) -> Request<StripeKit.Person> {
            Request(method: "POST", url: path, body: body.map(URLQueryEncoder.encode)?.percentEncodedQuery, id: "PostAccountPeoplePerson")
        }
        ...
        public var delete: Request<StripeKit.DeletedPerson> {
            Request(method: "DELETE", url: path, id: "DeleteAccountPeoplePerson")
        }
    }
}
