...
extension Paths.Issuing {
    ...
    public struct Cards {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<GetResponse> {
            Request(method: "GET", url: path, query: parameters?.asQuery, id: "GetIssuingCards")
        }

        /// IssuingCardList
        public struct GetResponse: Decodable {
            public var data: [StripeKit.IssuingCard]
            ...
            public init(data: [StripeKit.IssuingCard], hasMore: Bool, object: Object, url: String) {
                self.data = data
            ...
            public init(from decoder: Decoder) throws {
                ...
                self.data = try values.decode([StripeKit.IssuingCard].self, forKey: "data")
        ...
        public func post(_ body: PostRequest) -> Request<StripeKit.IssuingCard> {
            Request(method: "POST", url: path, body: URLQueryEncoder.encode(body).percentEncodedQuery, id: "PostIssuingCards")
        }
        ...
        public struct PostRequest: Encodable {
            ...
            public init(cardholder: String? = nil, currency: String, expand: [String]? = nil, financialAccount: String? = nil, metadata: [String: String]? = nil, replacementFor: String? = nil, replacementReason: ReplacementReason? = nil, shipping: Shipping? = nil, spendingControls: SpendingControls? = nil, status: Status? = nil, type: `Type`) {
                self.cardholder = cardholder
