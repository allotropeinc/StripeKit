...
extension Paths {
    ...
    public struct SetupAttempts {
        ...
        public func get(parameters: GetParameters) -> Request<GetResponse> {
            Request(method: "GET", url: path, query: parameters.asQuery, id: "GetSetupAttempts")
        }

        /// PaymentFlowsSetupIntentSetupAttemptList
        public struct GetResponse: Decodable {
            public var data: [StripeKit.SetupAttempt]
            ...
            public init(data: [StripeKit.SetupAttempt], hasMore: Bool, object: Object, url: String) {
                self.data = data
            ...
            public init(from decoder: Decoder) throws {
                ...
                self.data = try values.decode([StripeKit.SetupAttempt].self, forKey: "data")
