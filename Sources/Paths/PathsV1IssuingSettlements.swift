...
extension Paths.Issuing {
    ...
    public struct Settlements {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<GetResponse> {
            Request(method: "GET", url: path, query: parameters?.asQuery, id: "GetIssuingSettlements")
        }

        /// IssuingSettlementList
        public struct GetResponse: Decodable {
            public var data: [StripeKit.IssuingSettlement]
            ...
            public init(data: [StripeKit.IssuingSettlement], hasMore: Bool, object: Object, url: String) {
                self.data = data
            ...
            public init(from decoder: Decoder) throws {
                ...
                self.data = try values.decode([StripeKit.IssuingSettlement].self, forKey: "data")
