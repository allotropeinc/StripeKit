...
extension Paths.Sigma {
    ...
    public struct ScheduledQueryRuns {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<GetResponse> {
            Request(method: "GET", url: path, query: parameters?.asQuery, id: "GetSigmaScheduledQueryRuns")
        }

        /// SigmaScheduledQueryRunList
        public struct GetResponse: Decodable {
            public var data: [StripeKit.ScheduledQueryRun]
            ...
            public init(data: [StripeKit.ScheduledQueryRun], hasMore: Bool, object: Object, url: String) {
                self.data = data
            ...
            public init(from decoder: Decoder) throws {
                ...
                self.data = try values.decode([StripeKit.ScheduledQueryRun].self, forKey: "data")
