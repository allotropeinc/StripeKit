...
extension Paths.Orders {
    ...
    public struct WithID {
        ...
        public func get(expand: [String]? = nil) -> Request<StripeKit.Order> {
            Request(method: "GET", url: path, query: makeGetQuery(expand), id: "GetOrdersId")
        }
        ...
        public func post(_ body: PostRequest? = nil) -> Request<StripeKit.Order> {
            Request(method: "POST", url: path, body: body.map(URLQueryEncoder.encode)?.percentEncodedQuery, id: "PostOrdersId")
        }
        ...
        public struct PostRequest: Encodable {
            ...
            public struct LineItem: Encodable {
                ...
                public init(description: String? = nil, discounts: Discounts? = nil, id: String? = nil, price: String? = nil, priceData: PriceData? = nil, product: String? = nil, productData: ProductData? = nil, quantity: Int? = nil, taxRates: TaxRates? = nil) {
                    self.description = description
            ...
            public struct Payment: Encodable {
                ...
                public struct Settings: Encodable {
                    ...
                    public var returnURL: ReturnURL?
                    ...
                    public struct ReturnURL: Encodable {
                        public var string: String?
                        public var object: Object?
                    ...
                    public init(applicationFeeAmount: ApplicationFeeAmount? = nil, paymentMethodOptions: PaymentMethodOptions? = nil, paymentMethodTypes: [PaymentMethodType]? = nil, returnURL: ReturnURL? = nil, statementDescriptor: String? = nil, statementDescriptorSuffix: String? = nil, transferData: TransferData? = nil) {
            ...
            public init(automaticTax: AutomaticTax? = nil, billingDetails: BillingDetails? = nil, currency: String? = nil, customer: String? = nil, description: String? = nil, discounts: Discounts? = nil, expand: [String]? = nil, ipAddress: String? = nil, lineItems: [LineItem]? = nil, metadata: Metadata? = nil, payment: Payment? = nil, shippingCost: ShippingCost? = nil, shippingDetails: ShippingDetails? = nil, taxDetails: TaxDetails? = nil) {
