...
extension Paths {
    ...
    public struct TaxCodes {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<GetResponse> {
            Request(method: "GET", url: path, query: parameters?.asQuery, id: "GetTaxCodes")
        }

        /// TaxProductResourceTaxCodeList
        public struct GetResponse: Decodable {
            public var data: [StripeKit.TaxCode]
            ...
            public init(data: [StripeKit.TaxCode], hasMore: Bool, object: Object, url: String) {
                self.data = data
            ...
            public init(from decoder: Decoder) throws {
                ...
                self.data = try values.decode([StripeKit.TaxCode].self, forKey: "data")
