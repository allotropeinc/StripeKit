...
extension Paths.Accounts.WithAccount.ExternalAccounts {
    ...
    public struct WithID {
        ...
        public func get(expand: [String]? = nil) -> Request<StripeKit.ExternalAccount> {
            Request(method: "GET", url: path, query: makeGetQuery(expand), id: "GetAccountsAccountExternalAccountsId")
        }
        ...
        public func post(_ body: PostRequest? = nil) -> Request<StripeKit.ExternalAccount> {
            Request(method: "POST", url: path, body: body.map(URLQueryEncoder.encode)?.percentEncodedQuery, id: "PostAccountsAccountExternalAccountsId")
        }
        ...
        public var delete: Request<StripeKit.DeletedExternalAccount> {
            Request(method: "DELETE", url: path, id: "DeleteAccountsAccountExternalAccountsId")
        }
    }
}
