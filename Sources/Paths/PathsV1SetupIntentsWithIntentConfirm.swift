...
extension Paths.SetupIntents.WithIntent {
    ...
    public struct Confirm {
        ...
        public func post(_ body: PostRequest? = nil) -> Request<StripeKit.SetupIntent> {
            Request(method: "POST", url: path, body: body.map(URLQueryEncoder.encode)?.percentEncodedQuery, id: "PostSetupIntentsIntentConfirm")
        }
        ...
        public struct PostRequest: Encodable {
            ...
            public init(clientSecret: String? = nil, expand: [String]? = nil, mandateData: MandateData? = nil, paymentMethod: String? = nil, paymentMethodData: PaymentMethodData? = nil, paymentMethodOptions: PaymentMethodOptions? = nil, returnURL: String? = nil) {
