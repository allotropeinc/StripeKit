...
extension Paths.Radar {
    ...
    public struct EarlyFraudWarnings {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<GetResponse> {
            Request(method: "GET", url: path, query: parameters?.asQuery, id: "GetRadarEarlyFraudWarnings")
        }

        /// RadarEarlyFraudWarningList
        public struct GetResponse: Decodable {
            public var data: [StripeKit.RadarEarlyFraudWarning]
            ...
            public init(data: [StripeKit.RadarEarlyFraudWarning], hasMore: Bool, object: Object, url: String) {
                self.data = data
            ...
            public init(from decoder: Decoder) throws {
                ...
                self.data = try values.decode([StripeKit.RadarEarlyFraudWarning].self, forKey: "data")
