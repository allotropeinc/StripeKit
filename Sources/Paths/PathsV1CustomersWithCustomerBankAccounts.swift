...
extension Paths.Customers.WithCustomer {
    ...
    public struct BankAccounts {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<GetResponse> {
            Request(method: "GET", url: path, query: parameters?.asQuery, id: "GetCustomersCustomerBankAccounts")
        }

        /// BankAccountList
        public struct GetResponse: Decodable {
            /// Details about each object.
            public var data: [StripeKit.BankAccount]
            ...
            public init(data: [StripeKit.BankAccount], hasMore: Bool, object: Object, url: String) {
                self.data = data
            ...
            public init(from decoder: Decoder) throws {
                ...
                self.data = try values.decode([StripeKit.BankAccount].self, forKey: "data")
        ...
        public func post(_ body: PostRequest? = nil) -> Request<StripeKit.PaymentSource> {
            Request(method: "POST", url: path, body: body.map(URLQueryEncoder.encode)?.percentEncodedQuery, id: "PostCustomersCustomerBankAccounts")
        }
