...
extension Paths.Accounts.WithAccount.BankAccounts {
    ...
    public struct WithID {
        ...
        public func get(expand: [String]? = nil) -> Request<StripeKit.ExternalAccount> {
            Request(method: "GET", url: path, query: makeGetQuery(expand), id: "GetAccountsAccountBankAccountsId")
        }
        ...
        public func post(_ body: PostRequest? = nil) -> Request<StripeKit.ExternalAccount> {
            Request(method: "POST", url: path, body: body.map(URLQueryEncoder.encode)?.percentEncodedQuery, id: "PostAccountsAccountBankAccountsId")
        }
        ...
        public var delete: Request<StripeKit.DeletedExternalAccount> {
            Request(method: "DELETE", url: path, id: "DeleteAccountsAccountBankAccountsId")
        }
    }
}
