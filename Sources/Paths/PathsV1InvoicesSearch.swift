...
extension Paths.Invoices {
    ...
    public struct Search {
        ...
        public func get(parameters: GetParameters) -> Request<GetResponse> {
            Request(method: "GET", url: path, query: parameters.asQuery, id: "GetInvoicesSearch")
        }
        ...
        public struct GetResponse: Decodable {
            ...
            public init(data: [StripeKit.Invoice], hasMore: Bool, nextPage: String? = nil, object: Object, totalCount: Int? = nil, url: String) {
                self.data = data
