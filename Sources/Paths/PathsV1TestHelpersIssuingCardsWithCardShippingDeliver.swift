...
extension Paths.TestHelpers.Issuing.Cards.WithCard.Shipping {
    public var deliver: Deliver {
        Deliver(path: path + "/deliver")
    }
    ...
    public struct Deliver {
        ...
        public func post(_ body: PostRequest? = nil) -> Request<StripeKit.IssuingCard> {
            Request(method: "POST", url: path, body: body.map(URLQueryEncoder.encode)?.percentEncodedQuery, id: "PostTestHelpersIssuingCardsCardShippingDeliver")
        }
