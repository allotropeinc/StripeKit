...
extension Paths {
    ...
    public struct SetupIntents {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<GetResponse> {
            Request(method: "GET", url: path, query: parameters?.asQuery, id: "GetSetupIntents")
        }

        /// PaymentFlowsSetupIntentList
        public struct GetResponse: Decodable {
            public var data: [StripeKit.SetupIntent]
            ...
            public init(data: [StripeKit.SetupIntent], hasMore: Bool, object: Object, url: String) {
                self.data = data
            ...
            public init(from decoder: Decoder) throws {
                ...
                self.data = try values.decode([StripeKit.SetupIntent].self, forKey: "data")
        ...
        public struct GetParameters {
            ...
            public init(isAttachToSelf: Bool? = nil, created: Created? = nil, customer: String? = nil, endingBefore: String? = nil, expand: [String]? = nil, limit: Int? = nil, paymentMethod: String? = nil, startingAfter: String? = nil) {
        ...
        public func post(_ body: PostRequest? = nil) -> Request<StripeKit.SetupIntent> {
            Request(method: "POST", url: path, body: body.map(URLQueryEncoder.encode)?.percentEncodedQuery, id: "PostSetupIntents")
        }
        ...
        public struct PostRequest: Encodable {
            ...
            public init(isAttachToSelf: Bool? = nil, isConfirm: Bool? = nil, customer: String? = nil, description: String? = nil, expand: [String]? = nil, flowDirections: [FlowDirection]? = nil, mandateData: MandateData? = nil, metadata: [String: String]? = nil, onBehalfOf: String? = nil, paymentMethod: String? = nil, paymentMethodData: PaymentMethodData? = nil, paymentMethodOptions: PaymentMethodOptions? = nil, paymentMethodTypes: [String]? = nil, returnURL: String? = nil, singleUse: SingleUse? = nil, usage: Usage? = nil) {
                self.isAttachToSelf = isAttachToSelf
