...
extension Paths.Customers.WithCustomer.Sources {
    ...
    public struct WithID {
        ...
        public func get(expand: [String]? = nil) -> Request<StripeKit.PaymentSource> {
            Request(method: "GET", url: path, query: makeGetQuery(expand), id: "GetCustomersCustomerSourcesId")
        }
        ...
        public func post(_ body: PostRequest? = nil) -> Request<PostResponse> {
            Request(method: "POST", url: path, body: body.map(URLQueryEncoder.encode)?.percentEncodedQuery, id: "PostCustomersCustomerSourcesId")
        }
        ...
        public func delete(_ body: DeleteRequest? = nil) -> Request<DeleteResponse> {
            Request(method: "DELETE", url: path, body: body.map(URLQueryEncoder.encode)?.percentEncodedQuery, id: "DeleteCustomersCustomerSourcesId")
        }
