...
extension Paths.Sources.WithSource {
    ...
    public struct SourceTransactions {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<GetResponse> {
            Request(method: "GET", url: path, query: parameters?.asQuery, id: "GetSourcesSourceSourceTransactions")
        }

        /// ApmsSourcesSourceTransactionList
        public struct GetResponse: Decodable {
            public var data: [StripeKit.SourceTransaction]
            ...
            public init(data: [StripeKit.SourceTransaction], hasMore: Bool, object: Object, url: String) {
                self.data = data
            ...
            public init(from decoder: Decoder) throws {
                ...
                self.data = try values.decode([StripeKit.SourceTransaction].self, forKey: "data")
